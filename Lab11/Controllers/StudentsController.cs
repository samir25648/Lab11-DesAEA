...
namespace Lab11.Controllers
{
    public class StudentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("StudentID,GradeID,FirstName,LastName,Phone,Email,Active")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("StudentID,GradeID,FirstName,LastName,Phone,Email,Active")] Student student)
        {
